...
exports.onDragNode = function (_a) {
    ...
    return function (chart) {
        ...
        if (nodechart) {
            var position = getOffset(config, data);
            chart.nodes[id] = __assign(__assign({}, nodechart), { position: position });
        }
        return chart;
    };
};
...
exports.onDragCanvasStop = function () {
    return __1.identity;
};
...
exports.onNodeMouseEnter = function (_a) {
    ...
    return function (chart) {
        return __assign(__assign({}, chart), { hovered: {
                type: 'node',
                id: nodeId,
            } });
    };
